...
//
//   - [github.com/nnikolash/wasp-types-exported/packages/vm/core/evm/evmtest]: solo tests
//     for the EVM core contract
//   - [github.com/nnikolash/wasp-types-exported/packages/evm/jsonrpc/jsonrpctest]: solo
//     tests for the JSONRPC service
//   - tools/cluster/tests/evm_jsonrpc_test.go: cluster tests
//   - [github.com/nnikolash/wasp-types-exported/packages/evm/evmtest]: common Solidity
//     code used in tests
//
