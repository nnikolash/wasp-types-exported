...
old_wasmlib="wasmlib = { git = \"https://github.com/nnikolash/wasp-types-exported\", branch = \"develop\" }"
...
old_wasmhost="wasmvmhost = { git = \"https://github.com/nnikolash/wasp-types-exported\", branch = \"develop\" }"
