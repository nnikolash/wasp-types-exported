...
import (
	"github.com/nnikolash/wasp-types-exported/contracts/wasm/testcore/go/testcore"
	...
	"github.com/nnikolash/wasp-types-exported/packages/wasmvm/wasmlib/go/wasmlib/coregovernance"
