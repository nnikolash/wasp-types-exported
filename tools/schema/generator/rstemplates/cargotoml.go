...
`,
	...
	"dependenciesLib": `
[dependencies]
$env_wasmlib$+wasmlib = { git = "https://github.com/nnikolash/wasp-types-exported", branch = "develop" }
`,
	// *******************************
	"dependenciesImpl": `
[dependencies]
...
$env_wasmvmhost$+wasmvmhost = { git = "https://github.com/nnikolash/wasp-types-exported", branch = "develop" }
